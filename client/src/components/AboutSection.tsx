        ...
        >
          ...
          >
            <div className="relative">
              ...
              <motion.div 
                ...
                animate={isInView ? { opacity: 1, scale: 1, rotate: 6 } : { opacity: 0, scale: 0 }}
          ...
          >
            ...
            <motion.div className="mb-8" variants={itemVariants}>
              <h2 className="text-3xl lg:text-4xl font-heading font-bold text-dark-900 dark:text-white mb-4">About Me</h2>
            ...
            <div className="space-y-6 text-dark-700 dark:text-dark-100">
              <motion.p className="text-lg" variants={itemVariants}>
                Passionate about technology, I'm a curious and autonomous student who loves discovering 
                new things and taking on challenges. I've mastered various technologies and I'm ready to 
                put my skills to work to support your team.
              </motion.p>
              
              <motion.p variants={itemVariants}>
                Currently pursuing an Engineering degree in Computer Science at EFREI Paris, I have experience 
                working with diverse technologies across multiple projects and professional environments.
              </motion.p>
              
              <motion.p variants={itemVariants}>
                When I'm not coding, you can find me playing basketball, practicing Sambo, keeping up with the 
                latest tech trends, or enjoying gaming sessions with FIFA, F1, NBA2K, and GTA.
              </motion.p>
              
              {/* Personal Information */}
              <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-3" variants={itemVariants}>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span>abdou.k.kandji@gmail.com</span>
                </div>
                <div className="flex items-center gap-3">
              ...
              <motion.div className="pt-4" variants={itemVariants}>
                <a href="/resume.pdf" target="_blank" className="inline-flex items-center gap-2 px-6 py-3 bg-white dark:bg-dark-700 hover:bg-gray-100 dark:hover:bg-dark-600 text-dark-800 dark:text-white border border-gray-300 dark:border-dark-600 font-semibold rounded-lg shadow-sm hover:shadow-md transition-all duration-300">
