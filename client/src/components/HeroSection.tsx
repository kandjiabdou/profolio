      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-3xl">
          <div className="space-y-8">
            ...
            >
              <a href="https://github.com/kandjiabdou" target="_blank" rel="noopener noreferrer" className="text-dark-700 dark:text-dark-100 hover:text-primary-600 dark:hover:text-primary-500 transition-colors duration-300">
                <i className="fa-brands fa-github text-2xl"></i>
              </a>
              <a href="https://linkedin.com/in/kandji" target="_blank" rel="noopener noreferrer" className="text-dark-700 dark:text-dark-100 hover:text-primary-600 dark:hover:text-primary-500 transition-colors duration-300">
                <i className="fa-brands fa-linkedin text-2xl"></i>
              </a>
              <a href="mailto:abdou.k.kandji@gmail.com" className="text-dark-700 dark:text-dark-100 hover:text-primary-600 dark:hover:text-primary-500 transition-colors duration-300">
                <i className="fa-solid fa-envelope text-2xl"></i>
              </a>
              <a href="tel:0758054947" className="text-dark-700 dark:text-dark-100 hover:text-primary-600 dark:hover:text-primary-500 transition-colors duration-300">
